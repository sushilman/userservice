...
func (c *userServiceClient) CreateUser(ctx context.Context, in *UserCreation, opts ...grpc.CallOption) (*UserCreationResponse, error) {
...
func (c *userServiceClient) GetUsers(ctx context.Context, in *UserFilter, opts ...grpc.CallOption) (UserService_GetUsersClient, error) {
	stream, err := c.cc.NewStream(ctx, &UserService_ServiceDesc.Streams[0], "/userservice.UserService/GetUsers", opts...)
	if err != nil {
		return nil, err
	}
...
func (UnimplementedUserServiceServer) CreateUser(context.Context, *UserCreation) (*UserCreationResponse, error) {
...
func _UserService_CreateUser_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServiceServer).CreateUser(ctx, req.(*UserCreation))
	}
